  ...
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 py-8 md:py-10">
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        <span className="text-body-tag bg-blue-400 text-blue-200 px-2 py-1 w-fit rounded-sm uppercase">
          Simples
        </span>
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          ...
          <div className="flex flex-col items-center justify-center w-full">
            ...
            <Button className="w-full gap-2 rounded-full mt-4 md:hidden" asChild>
              <Link href="/criar-loja">
                Criar loja grátis
                <ArrowRightIcon />
              </Link>
