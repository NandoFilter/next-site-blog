...
export const PostCard = (post: PostCardProps) => {
  return (
    <Link href={`/blog/${post.slug}`} className="w-full max-w-2xl rounded-xl border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:border-[1px] hover:border-blue-300">
      {/* Post Content */}
